...
test('change event', () => {
  ...
  const item4 = wrapper.findAll('.ghb-rate__icon').at(3);
...
test('allow half', () => {
  ...
  const item4 = wrapper.findAll('.ghb-rate__icon--half').at(3);
...
test('disabled', () => {
  ...
  const item4 = wrapper.findAll('.ghb-rate__item').at(3);
...
test('touchmove to select item', () => {
  ...
  const icons = wrapper.findAll('.ghb-rate__item');
