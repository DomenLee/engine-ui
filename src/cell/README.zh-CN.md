...
<ghb-cell-group>
  ...
  <ghb-cell title="单元格" value="内容" label="描述信息" />
</ghb-cell-group>
```
...
```html
<ghb-cell title="单元格" value="内容" size="large" />
<ghb-cell title="单元格" value="内容" size="large" label="描述信息" />
```
...
```html
<ghb-cell title="单元格" icon="location-o" />
```
...
```html
<ghb-cell title="单元格" is-link />
<ghb-cell title="单元格" is-link value="内容" />
<ghb-cell title="单元格" is-link arrow-direction="down" value="内容" />
```
...
```html
<ghb-cell title="URL 跳转" is-link url="/vant/mobile.html" />
<ghb-cell title="路由跳转" is-link to="index" />
```
...
```html
<ghb-cell-group title="分组1">
  <ghb-cell title="单元格" value="内容" />
</ghb-cell-group>
<ghb-cell-group title="分组2">
  <ghb-cell title="单元格" value="内容" />
</ghb-cell-group>
```
...
<ghb-cell title="单元格" icon="shop-o">
...
```html
<ghb-cell center title="单元格" value="内容" label="描述信息" />
```
