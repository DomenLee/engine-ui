...
以下是关于向 GHBUI 提交反馈或代码的指南。在向 GHBUI 提交 issue 或者 PR 之前，请先花几分钟时间阅读以下文字。
...
按照下面的步骤操作，即可在本地开发 GHBUI 组件。

```bash
# 克隆仓库
# 默认为 dev 分支，包含 GHBUI 3 的代码
# 如果需要在 GHBUI 2 上进行更改，请基于 2.x 分支进行开发
